...
class TutorialOverlay:
    ...
    def __init__(self):
        ...
        # Fonts
        self.font_title = get_font('Segoe UI', 48, bold=True)
        self.font_main = get_font('Segoe UI', 28)
        self.font_hint = get_font('Segoe UI', 22)
        self.font_key = get_font('Consolas', 32, bold=True)
...
class ControlsDisplay:
    ...
    def __init__(self):
        pygame.font.init()
        self.font_key = get_font('Consolas', 16, bold=True)
        self.font_desc = get_font('Segoe UI', 14)
...
class GameTips:
    ...
    def __init__(self):
        pygame.font.init()
        self.font = get_font('Segoe UI', 20)
        self.current_tip = 0
        self._timer = 0.0
